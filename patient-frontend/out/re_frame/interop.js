...
return [(function (){var pred__10724 = cljs.core.instance_QMARK_;
var expr__10725 = reactive_val;
if(cljs.core.truth_(pred__10724.call(null,reagent.ratom.RAtom,expr__10725))){
return "ra";
} else {
if(cljs.core.truth_(pred__10724.call(null,reagent.ratom.RCursor,expr__10725))){
return "rc";
} else {
if(cljs.core.truth_(pred__10724.call(null,reagent.ratom.Reaction,expr__10725))){
return "rx";
} else {
if(cljs.core.truth_(pred__10724.call(null,reagent.ratom.Track,expr__10725))){
return "tr";
} else {
return "other";
}
