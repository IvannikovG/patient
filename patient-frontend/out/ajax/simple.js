...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__1194){
var map__1195 = p__1194;
var map__1195__$1 = (((((!((map__1195 == null))))?(((((map__1195.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1195.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1195):map__1195);
var handler = cljs.core.get.call(null,map__1195__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.update.call(null,cljs.core.update.call(null,request,new cljs.core.Keyword(null,"method","method",55703592),ajax.simple.normalize_method),new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),(function (p1__1197_SHARP_){
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4126__auto__ = p1__1197_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__1198){
var map__1199 = p__1198;
var map__1199__$1 = (((((!((map__1199 == null))))?(((((map__1199.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1199.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1199):map__1199);
var request = map__1199__$1;
var interceptors = cljs.core.get.call(null,map__1199__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
