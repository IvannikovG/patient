...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_690 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_690.call(null,this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_691 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_691.call(null,this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_692 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_692.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_693 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_693.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_694 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_694.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_695 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_695.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_696 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_696.call(null,this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_697 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_697.call(null,this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_698 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_698.call(null,this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_699 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_699.call(null,this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k701,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k701,else__4383__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4402__auto__,p__706){
var vec__707 = p__706;
var k__4403__auto__ = cljs.core.nth.call(null,vec__707,(0),null);
var v__4404__auto__ = cljs.core.nth.call(null,vec__707,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__700){
var self__ = this;
var G__700__$1 = this;
return (new cljs.core.RecordIter((0),G__700__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this702,other703){
var self__ = this;
var this702__$1 = this;
return (((!((other703 == null)))) && ((this702__$1.constructor === other703.constructor)) && (cljs.core._EQ_.call(null,this702__$1.status,other703.status)) && (cljs.core._EQ_.call(null,this702__$1.body,other703.body)) && (cljs.core._EQ_.call(null,this702__$1.status_text,other703.status_text)) && (cljs.core._EQ_.call(null,this702__$1.headers,other703.headers)) && (cljs.core._EQ_.call(null,this702__$1.was_aborted,other703.was_aborted)) && (cljs.core._EQ_.call(null,this702__$1.__extmap,other703.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__700){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__710 = cljs.core.keyword_identical_QMARK_;
var expr__711 = k__4388__auto__;
if(cljs.core.truth_(pred__710.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__711))){
return (new ajax.protocols.Response(G__700,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__710.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__711))){
return (new ajax.protocols.Response(self__.status,G__700,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__710.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__711))){
return (new ajax.protocols.Response(self__.status,self__.body,G__700,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__710.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__711))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__700,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__710.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__711))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__700,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4388__auto__,G__700),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__700){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__700,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__704){
var extmap__4419__auto__ = (function (){var G__713 = cljs.core.dissoc.call(null,G__704,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__704)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__713);
} else {
return G__713;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__704),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__704),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__704),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__704),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__704),null,cljs.core.not_empty.call(null,extmap__4419__auto__),null));
});
