...
var G__1578 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__1578,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__1578;
}
}));
...
var len__4736__auto___1583 = arguments.length;
var i__4737__auto___1584 = (0);
while(true){
if((i__4737__auto___1584 < len__4736__auto___1583)){
args__4742__auto__.push((arguments[i__4737__auto___1584]));

var G__1585 = (i__4737__auto___1584 + (1));
i__4737__auto___1584 = G__1585;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq1580){
var G__1581 = cljs.core.first.call(null,seq1580);
var seq1580__$1 = cljs.core.next.call(null,seq1580);
var G__1582 = cljs.core.first.call(null,seq1580__$1);
var seq1580__$2 = cljs.core.next.call(null,seq1580__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1581,G__1582,seq1580__$2);
}));
...
var file = cljs.core.get.call(null,map__1587__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__1587__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__1587__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__1586_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__1586_SHARP_));
...
var temp__5735__auto___1589 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___1589)){
var message_1590 = temp__5735__auto___1589;
cljs.core.println.call(null,message_1590);
} else {
}
...
var temp__5735__auto___1591 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___1591)){
var message_1592 = temp__5735__auto___1591;
cljs.core.println.call(null,message_1592);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__1593 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__1595 = exception.stack;
var G__1595__$1 = (((G__1595 == null))?null:clojure.string.split_lines.call(null,G__1595));
var G__1595__$2 = (((G__1595__$1 == null))?null:cljs.core.get.call(null,G__1595__$1,depth));
if((G__1595__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__1595__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__1596 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__1596,(0),null);
var column = cljs.core.nth.call(null,vec__1596,(1),null);
var vec__1599 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__1599,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__1599,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__1599,(2),null);
...
var m__$1 = (function (){var G__1602 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__1606 = (function (){var G__1605 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__1605);
} else {
return G__1605;
}
})();
...
return cljs.core.vary_meta.call(null,G__1607,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e1608){var e = e1608;
var G__1609 = e;
var G__1609__$1 = (((G__1609 instanceof cljs.core.Keyword))?G__1609.fqn:null);
switch (G__1609__$1) {
...
var vec__1611 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__1611,(0),null);
var types = vec__1611;
...
return cljs.core.map.call(null,(function (p__1614){
var vec__1615 = p__1614;
var ns = cljs.core.nth.call(null,vec__1615,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__1615,(1),null);
return (function (){
...
var G__1618 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__1618__$1 = (((G__1618 instanceof cljs.core.Keyword))?G__1618.fqn:null);
switch (G__1618__$1) {
case "async":
...
var seq__1619 = cljs.core.seq.call(null,vars__$1);
var chunk__1620 = null;
var count__1621 = (0);
var i__1622 = (0);
while(true){
if((i__1622 < count__1621)){
var v = cljs.core._nth.call(null,chunk__1620,i__1622);
var temp__5735__auto___1624 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___1624)){
var t_1625 = temp__5735__auto___1624;
each_fixture_fn.call(null,((function (seq__1619,chunk__1620,count__1621,i__1622,t_1625,temp__5735__auto___1624,v,each_fixture_fn,G__1618,G__1618__$1,env,once_fixtures,each_fixtures,vec__1615,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1625)));
});})(seq__1619,chunk__1620,count__1621,i__1622,t_1625,temp__5735__auto___1624,v,each_fixture_fn,G__1618,G__1618__$1,env,once_fixtures,each_fixtures,vec__1615,ns,vars__$1))
);
} else {
}


var G__1626 = seq__1619;
var G__1627 = chunk__1620;
var G__1628 = count__1621;
var G__1629 = (i__1622 + (1));
seq__1619 = G__1626;
chunk__1620 = G__1627;
count__1621 = G__1628;
i__1622 = G__1629;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__1619);
if(temp__5735__auto__){
var seq__1619__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1619__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__1619__$1);
var G__1630 = cljs.core.chunk_rest.call(null,seq__1619__$1);
var G__1631 = c__4556__auto__;
var G__1632 = cljs.core.count.call(null,c__4556__auto__);
var G__1633 = (0);
seq__1619 = G__1630;
chunk__1620 = G__1631;
count__1621 = G__1632;
...
var v = cljs.core.first.call(null,seq__1619__$1);
var temp__5735__auto___1634__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___1634__$1)){
var t_1635 = temp__5735__auto___1634__$1;
each_fixture_fn.call(null,((function (seq__1619,chunk__1620,count__1621,i__1622,t_1635,temp__5735__auto___1634__$1,v,seq__1619__$1,temp__5735__auto__,each_fixture_fn,G__1618,G__1618__$1,env,once_fixtures,each_fixtures,vec__1615,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_1635)));
});})(seq__1619,chunk__1620,count__1621,i__1622,t_1635,temp__5735__auto___1634__$1,v,seq__1619__$1,temp__5735__auto__,each_fixture_fn,G__1618,G__1618__$1,env,once_fixtures,each_fixtures,vec__1615,ns,vars__$1))
);
} else {
}


var G__1636 = cljs.core.next.call(null,seq__1619__$1);
var G__1637 = null;
var G__1638 = (0);
var G__1639 = (0);
seq__1619 = G__1636;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__1618__$1)].join('')));
