...
goog.addDependency("../app/config.js", ['app.config'], ['cljs.core']);
goog.addDependency("../app/helpers.js", ['app.helpers'], ['cljs.core', 'clojure.string', 'clojure.walk']);
goog.addDependency("../app/current_query_parameters.js", ['app.current_query_parameters'], ['cljs.core', 're_frame.core']);
...
goog.addDependency("../app/events.js", ['app.events'], ['ajax.core', 'app.config', 'cljs.core', 'app.helpers', 'app.current_query_parameters', 'clojure.walk', 're_frame.core', 'day8.re_frame.http_fx']);
goog.addDependency("../app/subscriptions.js", ['app.subscriptions'], ['cljs.core', 'app.helpers', 're_frame.core']);
goog.addDependency("../app/new_integration_test.js", ['app.new_integration_test'], ['day8.re_frame.test', 'cljs.core', 'cljs.test', 'app.events', 'app.subscriptions', 're_frame.core']);
...
goog.addDependency("../app/test_runner.js", ['app.test_runner'], ['cljs.core', 'cljs.test', 'app.new_integration_test', 'figwheel.main.async_result']);
